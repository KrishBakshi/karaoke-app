...
print("🎵 Karaoke with Recording - OBS Compatible")
...
# Recording setup
RECORDING_PATH = "karaoke_output.wav"
...
ax.set_title("Karaoke with Recording")
ax.legend()
plt.tight_layout()
plt.show(block=False)

print("🎤 Starting karaoke with recording! Sing into your microphone...")
...
print("📹 Recording will be saved to karaoke_output.wav")
...
try:
    while True:
        ...
        # Mix with instrumental (voice prominent, background quieter)
        mix = 0.1 * instrumental + 0.7 * tuned_samples
