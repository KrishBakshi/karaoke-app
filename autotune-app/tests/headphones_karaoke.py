...
print("🎵 Headphones Karaoke System")

# Configuration - Using EarPods USB Audio
CHUNK = 1024
RATE = 48000  # EarPods support 48kHz
...
ax.set_title("Your Pitch (Headphones)")
plt.tight_layout()
plt.show(block=False)

print("🎤 Starting karaoke! Sing into your microphone...")
print("💡 You should hear the instrumental + your voice through your headphones")
