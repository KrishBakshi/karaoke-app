...
print("🎵 Priority Karaoke System (Smooth Instrumental)")
...
print("🎤 Starting priority karaoke! Sing into your microphone...")
print("💡 Instrumental should play smoothly with minimal lag")
